"""p_turisticos URL Configuration
...
from eventos.api.viewsets import AtracaoViewSet
...
router.register(r'eventos', AtracaoViewSet)
router.register(r'localizacao', EnderecoViewSet)
